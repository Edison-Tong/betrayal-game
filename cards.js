...
let cards = [
  ...
  //   effect: async (player) => {
  //     let trait = await getPlayerChoice(["knowledge", "sanity"], "Do you want to roll with Knowledge or Sanity?");
  ...
  //   todo: "Roll 2 dice.",
  //   result:
  //     "4: Nothing happens. <br><br> 3: Lose 1 speed. <br><br> 2: Lose 1 Sanity. <br><br> 1: lose 1 Knowledge. <br><br> 0: Lose 1 Might.",
  //   effect: async (player) => {
  ...
  //   result:
  //     "5+: Turn to haunt 1 in the TRAITORS TOME. You are the traitor. <br><br> 0-4: Gain 1 Speed. <br><br><br> If the haunt has started or if you choose not to make a haunt roll, take one die of Physical damage.",
  //   effect: async (player, hauntValue, hauntStarted) => {
  //     let answer = await getPlayerChoice(["yes", "no"], "Do you want to make a haunt roll?");
  ...
  //   todo: "If the haunt has not started, you may make a haunt roll",
  //   result:
  //     "5+: Turn to haunt 3 in the TRAITORS TOME. You are the haunt revealer. <br><br> 0-4: Gain 1 Sanity. <br><br><br> If the haunt has started or if you choose not to make a haunt roll, lose 1 Might and gain 1 Sanity.",
  //   effect: async (player, hauntValue, hauntStarted) => {
  //     let answer = await getPlayerChoice(["yes", "no"], "Do you want to make a haunt roll?");
  //     if (hauntStarted === true || answer === "no") {
  //       let playerStatsInfo = playerInfo[player.id.replace("p", "")].stats;
  ...
  //       handleTraitChange("physical", 1, "lose");
  //     } else {
  //       console.log("place explorer on an adjacent tile");
  ...
  //   todo: "Make a Might roll",
  //   result:
  //     "5+: Gain 1 Might or Speed. <br><br> 1-4: Gain 1 Speed and lose 1 Sanity. <br><br> 0: Take 2 General damage.",
  //   effect: async (player) => {
  //     let roll = await handleDiceRoll(player.stats.might);
  ...
  //   todo: "If the haunt has not started, you may make a haunt roll",
  //   result:
  //     "5+: Turn to haunt 7 in the SECRETS OF SURVIVAL book. this haunt has no traitor. you are the haunt revealer. <br><br> 0-4: Gain 1 Sanity. <br><br><br> If the haunt has started or if you choose not to make a haunt roll, draw an item card.",
  //   effect: async (player, hauntValue, hauntStarted) => {
  //     let answer = await getPlayerChoice(["yes", "no"], "Do you want to make a haunt roll?");
  //     if (hauntStarted === true || answer === "no") {
  //       handlePlayerGainsCard();
  ...
  //   effect: async (player) => {
  //     let trait = await getPlayerChoice(["speed", "might"], "Do you want to roll with Speed or Might?");
  //     let roll = await handleDiceRoll(player.stats[trait]);
  //     if (roll <= 4) {
  //       let roll = await handleDiceRoll(1);
  //       handleTraitChange("physical", roll, "lose");
  ...
  //   todo: "Make a Sanity roll",
  //   result:
  //     "4+: Gain 1 Knowledge. <br><br> 2-3: Gain 1 Knowledge and lose 1 Sanity. <br><br> 0-1: Take 2 Mental damage",
  //   effect: async (player) => {
  //     let roll = await handleDiceRoll(player.stats.sanity);
  ...
  //   result:
  //     "2+: Nothing happens. <br><br> 0-1: Lose 1 from that trait. <br><br><br> If you roll 2+ on all four rolls, gain 1 in any trait.",
  //   effect: async (player) => {
  //     let rollCount = 0;
  ...
  //   effect: async (player) => {
  //     let choice = await getPlayerChoice(["yes", "no"], "Would you like to inhale the scent?");
  //     if (choice === "yes") {
  //       let roll = await handleDiceRoll(2);
  //       window.alert(`You rolled: ${roll}`); //this is here for now so you can see what you rolled
  //       if (roll <= 2) {
  ...
  //   result:
  //     "6: Gain 1 in each trait. <br><br> 5: Gain 1 Might and 1 Speed. <br><br> 4: Gain 1 Knowledge and 1 Sanity. <br><br> 3: Gain 1 knowledge and lose 1 Might. <br><br> 2: Lose 1 Knowledge and 1 Sanity. <br><br> 1: Lose 1 Might and 1 Speed. <br><br> 0: Lose 1 in each trait.",
  //   effect: async (player) => {
  //     let choice = await getPlayerChoice(["yes", "no"], "Would you like to drink the fluid?");
  //     if (choice === "yes") {
  ...
  //   todo: "Roll 2 dice.",
  //   result:
  //     "4+: Gain 1 Sanity. <br><br> 3: Gain 1 Knowledge. <br><br> 1-2: Take one die of Mental damage. <br><br> 0: Take two dice of Physical damage.",
  //   effect: async (player) => {
  //     let roll = await handleDiceRoll(2);
  //     window.alert(`You rolled: ${roll}`); //this is here for now so you can see what you rolled
  ...
  //   todo: "If the haunt has not started, you may make a haunt roll.",
  //   result:
  //     "5+: Turn to haunt 33 in the TRAITOR'S TOME. If a hero has the Magic Camera, they are the traitor. Otherwise, you are the traitor. <br><br> 0-4: Draw an Item card. <br><br><br> If the haunt has started, or you chose not to make a haunt roll, draw an Item card.",
  //   effect: async (player, hauntValue, hauntStarted) => {
  //     let answer = await getPlayerChoice(["yes", "no"], "Do you want to make a haunt roll?");
  //     if (hauntStarted === true || answer === "no") {
  //       handlePlayerGainsCard();
  ...
  //   effect: async (player, hauntValue, hauntStarted) => {
  //     let answer = await getPlayerChoice(["yes", "no"], "Do you want to take 2 Physical damage?");
  //     if (answer === "yes") {
  ...
  //   todo: "Make a Sanity roll",
  //   result:
  //     "4+: Gain 1 Sanity or Speed. Place your explorer on an adjacent tile. <br><br> 2-3: Gain 1 Speed and lose 1 Sanity. <br><br> 0-1: Lose 1 speed.",
  //   effect: async (player, hauntValue, hauntStarted) => {
  //     let roll = await handleDiceRoll(player.stats.sanity);
  ...
  //     } else {
  //       let playerStatsInfo = playerInfo[player.id.replace("p", "")].stats;
  //       let answer = await getPlayerChoice(["sanity", "speed"], "Gain 1 Sanity or 1 Speed?");
  //       playerStatsInfo[answer].index++;
  //       renderPlayerStats();
  //       console.log("Place your explorer on an adjacent tile.");
  //       checkTileAdjacent(player.currentTile);
  //     }
  //   },
  // },
  ...
  //   todo: "If the haunt has not started, you may make a haunt roll.",
  //   result:
  //     "5+: Turn to haunt 12 in the TRAITOR'S TOME. This haunt has no traitor. You are the haunt revealer. <br><br> 0-4: Gain 1 Might. <br><br><br> If the haunt has starter or you chose not to make a haunt roll, gain 1 in any trait.",
  //   effect: async (player, hauntValue, hauntStarted) => {
  //     let answer = await getPlayerChoice(["yes", "no"], "Do you want to make a haunt roll?");
  //     if (hauntStarted === true || answer === "no") {
  //       handleTraitChange("general", 1, "gain");
  ...
  //   result:
  //     "5+: Gain 1 in the chosen trait. <br><br> 4: Lose 1 in the chosen trait. <br><br> 0-3: Heal the chosen trait.",
  //   effect: async (player, hauntValue, hauntStarted) => {
  //     let answer = await getPlayerChoice(["speed", "might", "knowledge", "sanity"], "Choose a trait to roll.");
  //     let roll = await handleDiceRoll(player.stats[answer]);
  //     if (roll <= 10) {
  //       let playerStatsInfo = playerInfo[player.id.replace("p", "")].stats;
  //       if (playerStatsInfo[answer].index < playerStatsInfo[answer].startingIndex) {
  //         playerStatsInfo[answer].index = playerStatsInfo[answer].startingIndex;
  //         renderPlayerStats();
  //       }
  //     } else if (roll === 4) {
  //       let playerStatsInfo = playerInfo[player.id.replace("p", "")].stats;
