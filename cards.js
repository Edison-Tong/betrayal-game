import { handleDiceRoll, handleTraitChange, getPlayerChoice, renderPlayerStats } from "./app.js";
...
let cards = [
  ...
  //   result: "4+: Nothing happens. <br> 2-3: Take 1 Physical damage. <br> 0-1: Take 3 Physical damage.",
  //   effect: async (player) => {
  ...
  //   result: "4+: Place your explorer on any tile in your region. <br> 0-3: Take 1 Mental damage",
  //   effect: async (player) => {
  ...
  //   result: "5+: Gain 1 Speed. <br> 0-4: Take 1 General damage.",
  //   effect: async (player) => {
  //     let trait = await getPlayerChoice(["knowledge", "sanity"]);
  ...
  //   type: "event",
  //   todo: "Make a Knowledge roll",
  //   result: " 4+: Gain 1 Sanity. <br> 0-3: Lose 1 Speed",
  //   effect: async (player) => {
  //     let roll = await handleDiceRoll(player.stats.knowledge);
  //     if (roll <= 3) {
  //       let playerStatsInfo = playerInfo[player.id.replace("p", "")].stats;
  ...
  //   todo: "Roll 2 dice.",
  //   result:
  //     "4: Nothing happens. <br> 3: Lose 1 speed. <br> 2: Lose 1 Sanity. <br> 1: lose 1 Knowledge. <br> 0: Lose 1 Might.",
  //   effect: async (player) => {
  ...
  // },
  {
    ...
    type: "event",
    todo: "Place a secret passage token on your tile. <br> Make a Knowledge roll.",
    result:
      "5+: Place another secret Passage token on any other tile. Gain 1 knowledge. <br> 3-4: Place another Secret Passage token on any Ground Floor tile. <br> 0-2: Place another Secret Passage token on any Basement Tile. Lose 1 Sanity.",
    effect: async (player) => {
      let roll = await handleDiceRoll(player.stats.knowledge);
      if (roll <= 2) {
        console.log("Place another Secret Passage token on any Basement Tile.");
        let playerStatsInfo = playerInfo[player.id.replace("p", "")].stats;
        playerStatsInfo.sanity.index--;
        renderPlayerStats();
      } else if (roll <= 4) {
        console.log("Place another Secret Passage token on any Ground Floor tile");
      } else {
        console.log("Place another secret Passage token on any other tile.");
        let playerStatsInfo = playerInfo[player.id.replace("p", "")].stats;
        playerStatsInfo.knowledge.index++;
        renderPlayerStats();
      }
  ...
  //     result: "5+: Turn to haunt 1 in the TRAITORS TOME. You are the traitor. <br> 0-4: Gain 1 Speed. <br><br> If the haunt has started or if you choose not to make a haunt roll, take one die of Physical damage.",
  // },
  // {
  //     name: "a vial of dust",
  //     type: "event",
  //     todo: "If the haunt has not started, you may make a haunt roll",
  //     result: "5+: Turn to haunt 3 in the TRAITORS TOME. You are the haunt revealer. <br> 0-4: Gain 1 Sanity. <br><br> If the haunt has started or if you choose not to make a haunt roll, lose 1 Might and gain 1 Sanity.",
  // },
  // {
  //     name: "bat out of hell",
  //     type: "event",
  //     todo: "Make a Speed roll",
  //     result: "4+: Place your explorer on an adjacent tile. <br> 0-3: Take 1 Physical damage.",
  // },
  // {
  //     name: "behind you!",
  //     type: "event",
  //     todo: "Make a Speed roll",
  //     result: "4+: Gain 1 Sanity. <br> 0-3: Take 1 Physical damage.",
  // },
  // {
  //     name: "brain food",
  //     type: "event",
  //     todo: "Make a Might roll",
  //     result: "5+: Gain 1 Might or Speed. <br> 1-4: Gain 1 Speed and lose 1 Sanity. <br> 0: Take 2 General damage.",
  // },
  // {
  //     name: "burning figure",
  //     type: "evnet",
  //     todo: "Make a Sanity roll",
  //     result: "4+: Gain 1 Sanity. <br> 2-3: Place your explorer on the Entrance Hall. <br> 0-1: Take 1 die of Physical damage and 1 die of Mental damage.",
  // },
  // {
  //     name: "cassette player",
  //     type: "event",
  //     todo: "Make a Sanity roll",
  //     result: "4+: Gain 1 knowledge. <br> 0-3: Take 1 Mental damage.",
  // },
  // {
  //     name: "clown room",
  //     type: "event",
  //     todo: "Make a Sanity roll",
  //     result: "4+: Nothing happens. <br> 0-3: Take 2 Mental damage.",
  // },
  // {
  //     name: "creaking door",
  //     type: "event",
  //     todo: "Make a Knowledge roll",
  //     result: "6+: Place your explorer on and Upper or Grounf Floor tile. <br> 4-5: Place your explorer on and Ground Floor tile. <br> 0-3: Place your explorer on the Basement Landing tile.",
  // },
  // {
  //     name: "dark and stormy night",
  //     type: "event",
  //     todo: " Make a Knowledge roll",
  //     result: "4+: Gain 1 Sanity. <br> 0-3: Take 1 Mental damage.",
  // },
  // {
  //     name: "eerie mirror",
  //     type: "event",
  //     todo: "If the haunt has not started, you may make a haunt roll",
  //     result: "5+: Turn to haunt 7 in the SECRETS OF SURVIVAL book. this haunt has no traitor. you are the haunt revealer. <br> 0-4: Gain 1 Sanity. <br><br> If the haunt has started or if you choose not to make a haunt roll, draw an item card.",
  // },
  // {
  //     name: "flickering lights",
  //     type: "event",
  //     todo: "Make a Speed or Might roll",
  //     result: "5+: Gain 1 Speed. <br> 0-4: Take one die of Physical damage.",
  // },
  // {
  //     name: "forbidden knowledge",
  //     type: "event",
  //     todo: "Make a Sanity roll",
  //     result: "4+: Gain 1 Knowledge. <br> 2-3: Gain 1 Knowledge and lose 1 Sanity. <br> 0-1: Take 2 Mental damage",
  // },
  // {
  //     name: "funeral",
  //     type: "event",
  //     todo: "Make a Sanity roll",
  //     result: "4+: Gain 1 Sanity. <br> 2-3 Lose 1 Sanity. <br> 0-1: Lose 1 Sanity and 1 Might. <br><br> If the Graveyard or Catacombs tiles have been discovered, place your explorer on one of those tiles.",
  // },
  // {
  //     name: "hanged man",
  //     type: "event",
  //     todo: "Roll each trait, one at a time.",
  //     result: "2+: Nothing happens. <br> 0-1: Lose 1 from that trait. <br><br> If you roll 2+ on all four rolls, gain 1 in any trait.",
  // },
  // {
  //     name: "impossible architecture",
  //     type: "event",
  //     todo: "Make a Sanity roll",
  //     result: "4+: Nothing happens. <br> 0-3: Take 1 die of Mental damage.",
  // },
  // {
  //     name: "jar of organs",
  //     type: "event",
  //     todo: "Make a Sanity roll",
  //     result: "4+: Draw an Item card. <br> 0-3: Lose 1 Might.",
  // },
  // {
  //     name: "jonah's turn",
  //     type: "event",
  ...
  //     result: "3-4: Gain1 in any trait. <br> 0-2: Take one die of Mental damage.",
  // },
  // {
  //     name: "mysterious fluid",
  //     type: "event",
  //     todo: "You may drink the fluid. If you do, roll 3 dice.",
  //     result: "6: Gain 1 in each trait. <br> 5: Gain 1 Might and 1 Speed. <br> 4: Gain 1 Knowledge and 1 Sanity. <br> 3: Gain 1 knowledge and lose 1 Might. <br> 2: Lose 1 Knowledge and 1 Sanity. <br> 1: Lose 1 Might and 1 Speed. <br> 0: Lose 1 in each trait.",
  // },
  // {
  //     name: "phone call",
  //     type: "event",
  //     todo: "Roll 2 dice.",
  //     result: "4+: Gain 1 Sanity. <br> 3: Gain 1 Knowledge. <br> 1-2: Take one die of Mental damage. <br> 0: Take two dice of Physical damage.",
  // },
  // {
  //     name: "poor yorick",
  //     type: "event",
  ...
  //     type: "event",
  //     todo: "Roll 2 dice.",
  //     result: " 3-4: Gain 1 Knowledge. <br> 0-2: Take one die of Mental damage.",
  // },
  // {
  //     name: "say cheese",
  //     type: "event",
  //     todo: "If the haunt has not started, you may make a haunt roll.",
  //     result: "5+: Turn to haunt 33 in the TRAITOR'S TOME. If a hero has the Magic Camera, they are the traitor. Otherwise, you are the traitor. <br> 0-4: Draw an Item card. <br><br> If the haunt has started, or you chose not to make a haunt roll, draw an Item card.",
  // },
  // {
  ...
  //     type: "event",
  //     todo: "Make a Sanity roll",
  //     result: "4+: Gain 1 Sanity or Speed. Place your explorer on an adjacent tile. <br> 2-3: Gain 1 Speed and lose 1 Sanity. <br> 0-1: Lose 1 speed.",
  // },
  // {
  //     name: "taxidermy",
  //     type: "event",
  //     todo: "Make a Might roll",
  //     result: "5+: Gain 1 Sanity. <br> 0-4: Take 1 Physical damage. Place and Obstacle token on this tile.",
  // },
  // {
  ...
  //     type: "event",
  //     todo: "Make a Speed roll",
  //     result: " 4+: Draw an Item card. <br> 1-3: Take Mental damage. <br> 0: Take one die of Physical damage. place your explorer on the Basement Landing.",
  // },
  // {
  //     name: "the flowering",
  //     type: "event",
  ...
  //     type: "event",
  //     todo: "If the haunt has not started, you may make a haunt roll.",
  //     result: "5+: Turn to haunt 12 in the TRAITOR'S TOME. This haunt has no traitor. You are the haunt revealer. <br> 0-4: Gain 1 Might. <br><br> If the haunt has starter or you chose not to make a haunt roll, gain 1 in any trait.",
  // },
  // {
  //     name: "the oldest hosue",
  //     type: "event",
  //     todo: "Make a Speed or Might roll",
  //     result: "5+: Place your explorer on any tile. <br> 3-4: Place your explorer on any Ground Floor tile. Take 1 General damage. <br> 0-2: Place your explorer on any Basement tile. Take 1 Mental damage.",
  // },
  // {
  //     name: "The stars ar night",
  //     type: "event",
  //     todo: "Choose a trait to roll",
  //     result: "5+: Gain 1 in the chosen trait. <br> 4: Lose 1 in the chosen trait. <br> 0-3: Heal the chosen trait.",
  // },
  // {
  //     name: "tiny robot",
  //     type: "event",
  //     todo: "Make a knowledge roll",
  //     result: "5+: Draw an Item card <br> 0-4: Take one die of Physical damage.",
  // },
  // {
  //     name: "wnadering ghost",
  //     type: "event",
  //     todo: "You may bury one of your items. If you do, gain 1 in any trait. Otherwise, make a Sanity roll.",
  //     result: "4+: Draw an Item card <br> 0-3: Take 1 General damage.",
  // },
];
